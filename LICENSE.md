...
> Discord poll and voting bot, advanced analytics 2026 — free, open-source, easy to set up.

<br>

## ✨ Features

📊 &nbsp;**Multiple choice** — polls with up to 10 options

⏱️ &nbsp;**Timed polls** — auto-end after set duration

🔒 &nbsp;**Anonymous** — hide who voted for what

📈 &nbsp;**Live results** — watch votes update in real time

🔁 &nbsp;**Recurring** — weekly check-ins on autopilot
